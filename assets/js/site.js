$(document).ready(function() {
    ...
    var yearsListEl = $(".years-list");
    // console.log(yearsListEl);
    yearsListEl.children("li").each(function(i) {
        var albumSpriteImg = $(this).find(".year-block__sprite");
        var palette = colorThief.getPalette(albumSpriteImg);
        console.log(albumSpriteImg)
        // console.log(palette);

    });
    // colorThief.getPalette("/albums/assets/images/covers/2018/css_sprites.png", 8);
});
// $(document).ready(function() {
//   var colorThief = new ColorThief(),
//       yearList = $("#year-list");
